...
foreach(ITK_VERSION main release-5.4)
  set(CTEST_SOURCE_DIRECTORY "/export/home/rtk/dashboard_tests/ITK-${ITK_VERSION}")
  foreach(FFTW ON)
    foreach(DEBUG_RELEASE Release Debug RelWithDebInfo)
      foreach(STATIC_SHARED Static Shared)
        ...
        set(CTEST_BINARY_DIRECTORY "/export/home/rtk/dashboard_tests/ITK-${ITK_VERSION}-${STATIC_SHARED}-${DEBUG_RELEASE}-FFTW${FFTW}")
